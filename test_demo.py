...
from models.PRRN import PRRN
from models.IMDN import IMDN


def main():

    utils_logger.logger_info('NTIRE2022-EfficientSR', log_path='NTIRE2022-EfficientSR_prrn.log')
    ...
    # testsets = '/home/yzj6850/houselee/eff_SR/datasets'
    ...
    model_path = os.path.join('model_zoo', 'PRRN_x4.pth')
    model = PRRN(scale=4)
    ...
    E_folder = os.path.join(testsets, testset_L+'_PRRN')
    util.mkdir(E_folder)
